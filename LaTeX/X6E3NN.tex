...
\geometry{paperwidth=265mm, paperheight=297mm, left=35mm, right=90mm, top=35mm, bottom=35mm, headheight=15mm, marginparwidth=80mm}
\setlength{\marginparwidth}{80mm}
\usepackage{marginfix}
\usepackage[colorinlistoftodos]{todonotes}
\usepackage{soul}
\definecolor{vikinote}{RGB}{185,175,240}
\newcommand{\viki}[2][]{\ifx&#1&\todo[color=vikinote!50,bordercolor=violet!70,linecolor=violet!80]{\textbf{Viki:} #2}\else\hl{#1}\todo[color=vikinote!50,bordercolor=violet!70,linecolor=violet!80]{\textbf{Viki:} #2}\fi}
...
\viki{Erről lehetne bővebben írni. Az adathalmazhoz járt egy README.txt, abban is van még több infó. Meg majd ide jöhet egy gráf kép, amiket generáltál. :)}

\subsection{Jelenlegi adatmezők}

\viki{Én ezzel a fejezettel azt csinálnám, hogy először csak elmesélném, hogy mit tartalmaz a JSON fájl, anélkül, hogy a JSON adatmezők neveit beletűzdelném. Nagyon döcögős ettől ez a fejezet és ha valaki a mezők nevére kíváncsi, az nem is nagyon tudja kimazsolázni azt a zárójelekből. Ezután vagy beszúrnék egy rövid JSON példát, amiben utána elmondanám, hogy mi mit jelent, vagy valami szép JSON struktúra leírót tennék a végére.}
